...
import 'package:mixpod/presentation/screens/HomeScreen/playlistWidgets/edit_playlist.dart';
import 'package:mixpod/presentation/screens/HomeScreen/playlistWidgets/music_in_playlist.dart';

import 'package:simple_gradient_text/simple_gradient_text.dart';

class Playlist_tab extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Stack(
      children: [
        ...
        Positioned(bottom: 20, right: 20, child: floatingAction(context)),
      ],
    );
  }

  SizedBox floatingAction(BuildContext context) {
    return SizedBox(
      width: 70,
      height: 70,
